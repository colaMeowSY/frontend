...
describe('MessageSentToMe', () => {
  test('should display message Content', () => {
    ...
    expect(avatar).toHaveAttribute('src', 'https://play-lh.googleusercontent.com/zepWGavYYErAIBXFZb6OT14I6b-m4TyaG3yjqZy6Hnsmi64vL3upQ3KUsV6Wnsm-e9M=w512');
...
describe('SendImageAsMessage', () => {
  test('should display messageContent', () => {
    ...
    expect(imageMessage).toHaveAttribute('src', 'https://play-lh.googleusercontent.com/zepWGavYYErAIBXFZb6OT14I6b-m4TyaG3yjqZy6Hnsmi64vL3upQ3KUsV6Wnsm-e9M=w512');
  });
});